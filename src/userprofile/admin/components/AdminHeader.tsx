...
const AdminHeader: React.FC<AdminHeaderProps> = ({ onLogout, onToggleSidebar, sidebarOpen }) => {
    ...
    const notificationsList = [
        { id: 1, message: 'New order #12345 has been placed', time: '10 min ago', read: false },
        { id: 2, message: 'New vendor registration waiting for approval', time: '1 hour ago', read: false },
        { id: 3, message: 'System update completed successfully', time: '3 hours ago', read: false },
        { id: 4, message: 'Inventory alert: Product XYZ is low in stock', time: '5 hours ago', read: false },
        { id: 5, message: 'Customer complaint submitted for order #12300', time: 'Yesterday', read: false },
    ];
    ...
    return (
        <header className="text-white shadow-md z-30" style={{
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        >
                            <motion.div
                                ...
                                transition={{ duration: 0.5 }}
                            >
                                <span style={{ color: sierraLeoneColors.blue }} className="font-bold text-xl">A</span>
                            </motion.div>
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <div className="relative">
                            ...
                            {showNotifications && (
                                ...
                                >
                                    <div className="p-3 text-white font-semibold" style={{
                                        background: `linear-gradient(90deg, ${sierraLeoneColors.green} 0%, ${sierraLeoneColors.blue} 100%)`
                                    }}>
                                        ...
                                        {notificationsList.map((notification) => (
                                            ...
                                            >
                                                <div className="flex items-start">
                                                    <div className={`w-2 h-2 rounded-full mt-1 mr-2 ${notification.read ? 'bg-gray-300' : 'bg-blue-700'}`}></div>
                                                    <div>
                                    ...
                                    <div className="p-2 bg-gray-50 text-center">
                                        <button className="text-blue-700 text-sm hover:underline">Mark all as read</button>
                                    </div>
                                </motion.div>
                            )}
                        </div>
