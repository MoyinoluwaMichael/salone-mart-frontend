...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ userData, activeTab, setActiveTab }) => {
    ...
    const navItems = [
        ...
        { id: 'document-types', label: 'Document Types', icon: <FileText size={20} /> },
        { id: 'product-categories', label: 'Product Categories', icon: <Tag size={20} /> },
        { id: 'product-brands', label: 'Product Brands', icon: <Bookmark size={20} /> },
                ...
                <div className="flex items-center justify-center flex-col">
                        ...
                        >
                            {userData.user.bioData?.profilePicture ? (
                                <img src={userData.user.bioData.profilePicture} alt="Profile" className="w-full h-full object-cover" />
                            ) : (
